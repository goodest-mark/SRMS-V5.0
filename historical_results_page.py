...
# Import your existing pages (they stay untouched)
...
class HistoricalResultsPage(QWidget):
    # Kept for MainWindow navigation
    ...
    def __init__(self):
        ...
        filter_layout.setAlignment(Qt.AlignCenter)   # <── Centered
        ...
        self.btn_ranking.setCheckable(True)
        self.btn_broadsheet.setCheckable(True)
        self.btn_remarks.setCheckable(True)
        self.btn_reports.setCheckable(True)

        self.btn_ranking.clicked.connect(lambda: self._switch_page(0))
        self.btn_broadsheet.clicked.connect(lambda: self._switch_page(1))
        self.btn_remarks.clicked.connect(lambda: self._switch_page(2))
        self.btn_reports.clicked.connect(lambda: self._switch_page(3))

        button_layout.addWidget(self.btn_ranking)
        ...
        # ─── 3. STACKED CONTENT (your existing pages) ────────────────
        ...
        self.stacked.addWidget(self.ranking_page)
        self.stacked.addWidget(self.broadsheet_page)
        self.stacked.addWidget(self.remarks_page)
        ...
        self._switch_page(0)   # default = Ranking
    ...
    def _switch_page(self, index):
        self.btn_ranking.setChecked(index == 0)
        self.btn_broadsheet.setChecked(index == 1)
        self.btn_remarks.setChecked(index == 2)
